...
import com.greenfirework.PFAATweaks.Tags;
...
import static com.greenfirework.PFAATweaks.mixinplugin.Target.VANILLA;
...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    private boolean loadJarOf(final Target mod) {
        try {
    ...
    public static File findJarOf(final Target mod) {
        try {
